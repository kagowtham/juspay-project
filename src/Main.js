...
(function(exports) {
  ...
  var func = function (i) {
      return function (faces) {
          return function (verticesPixLoc) {
              return function (ctx) {
                  ...
                  return function __do() {
                      var v = Data_Array_ST.peekSTArray(verticesPixLoc)(f0)();
                      var v1 = Data_Array_ST.peekSTArray(verticesPixLoc)(f1)();
                      var v2 = Data_Array_ST.peekSTArray(verticesPixLoc)(f2)();
                      var v3 = Data_Array_ST.peekSTArray(verticesPixLoc)(f3)();
                      var v0 = Data_Maybe.fromMaybe([  ])(v);
                      var v11 = Data_Maybe.fromMaybe([  ])(v1);
                      var v21 = Data_Maybe.fromMaybe([  ])(v2);
                      var v31 = Data_Maybe.fromMaybe([  ])(v3);
...
(function(exports) {
  ...
  var updater = function (st_vertices) {
      return function (x_angle) {
          return function (y_angle) {
              return function (t) {
                  return function (i) {
                      return function __do() {
                          var v = Data_Array_ST.peekSTArray(st_vertices)(i)();
                          var vi = Data_Maybe.fromMaybe([  ])(v);
                          ...
                          var v1 = Control_Monad_ST.readSTRef(y_angle)();
                          var v2 = Control_Monad_ST.readSTRef(x_angle)();
                          var v3 = Rotate.rotateX(v1 * 50.0)(x)(y)(z);
                          var mvx = Data_Array.index(v3)(0);
                          var mvy = Data_Array.index(v3)(1);
                          var mvz = Data_Array.index(v3)(2);
                          var vx = Data_Maybe.fromMaybe(0.0)(mvx);
                          var vy = Data_Maybe.fromMaybe(0.0)(mvy);
                          var vz = Data_Maybe.fromMaybe(0.0)(mvz);
                          var vv = Rotate.rotateY(50.0 * v2)(vx)(vy)(vz);
                          Data_Functor["void"](Control_Monad_Eff.functorEff)(Data_Array_ST.pushSTArray(t)(vv))();
                          var v4 = Data_Array_ST.emptySTArray();
                          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Data_Array_ST.pushSTArray(v4)(1))();
                      };
                  };
      ...
      return __unused()((function () {
          if (v instanceof Data_Maybe.Just) {
              return function __do() {
                  ...
                  var msz = -60.0;
                  var vertices = [ [ msz, 60.0, msz ], [ 60.0, 60.0, msz ], [ 60.0, msz, msz ], [ msz, msz, msz ], [ msz, 60.0, 60.0 ], [ 60.0, 60.0, 60.0 ], [ 60.0, msz, 60.0 ], [ msz, msz, 60.0 ] ];
                  ...
                  var updateCube = function __do() {
                      ...
                      Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Eff.forE(0)(8)(function (i) {
                          return updater(v13)(v11)(v12)(v14)(i);
                      }))();
          ...
          throw new Error("Failed pattern match at Main line 55, column 3 - line 56, column 3: " + [ v.constructor.name ]);
      })())();
  });
  exports["main"] = main;
